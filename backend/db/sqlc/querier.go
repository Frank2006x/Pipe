...
type Querier interface {
	...
	CreateRepositoryJobTemplate(ctx context.Context, arg CreateRepositoryJobTemplateParams) (RepositoryJobTemplate, error)
	CreateUser(ctx context.Context, arg CreateUserParams) (User, error)
	DeleteRepository(ctx context.Context, arg DeleteRepositoryParams) (int64, error)
	DeleteRepositoryJobTemplatesByRepo(ctx context.Context, repositoryID int64) error
	...
	ListRepositoryJobTemplates(ctx context.Context, arg ListRepositoryJobTemplatesParams) ([]RepositoryJobTemplate, error)
	ListRepositoryJobTemplatesInternal(ctx context.Context, repositoryID int64) ([]RepositoryJobTemplate, error)
