...
import { LogOut, Mail, Shield, User, GitBranch, Sun, Moon } from "lucide-react";
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 items-start">
            ...
            <div className="lg:col-span-4 space-y-6">
              <div className="p-8 rounded-lg border border-dashed border-border bg-card/10 flex flex-col items-center justify-center text-center min-h-[350px]">
